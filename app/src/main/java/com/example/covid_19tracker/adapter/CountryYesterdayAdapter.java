...
public class CountryYesterdayAdapter extends DataListAdapter<Country, SingleTodayLayoutBinding, OnItemActionListener> {

    SingleTodayLayoutBinding binding;
    private static final String TAG = "CountryYesterdayAdapter";
    

    public CountryYesterdayAdapter(OnItemClickedListener<Country> listener, OnItemLongClickListener<Country> longListener, OnItemActionListener actionListener) {
